...
* Enhanced Ruby Mode is intallable via el-get, where its package name is enh-ruby-mode (already in the master branch, to be merged in stable with the next release).
